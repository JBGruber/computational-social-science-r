...
subtitle: "[**Module 03**]{.kn-pink} [GESIS Fall Seminar \"Introduction to Computational Social Science\"]{.kn-blue}"
author:
...
![](media/optimal_tada_method.png){width=600}
...
The second table does the same, but with documents.
